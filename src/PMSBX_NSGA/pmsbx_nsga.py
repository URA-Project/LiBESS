...
from LiBESS.src.NSGA.conditions_nsga import *
from LiBESS.src.all_packages import *
from LiBESS.src.utilities.utils import _cal_end_date
...
data = pd.read_csv('/Users/twang/Documents/GitHub/LiBESS/data/data_test.csv')
...
def calculate_crowding_distance(front, chroms_obj_record):
    ...
    for o in range(2):  # Assuming there are two objectives.
        ...
        obj = {m: tuple(chroms_obj_record[m][o]) for m in front}  # Convert lists to tuples.
